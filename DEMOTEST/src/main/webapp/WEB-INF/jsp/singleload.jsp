            ...
            <div class="clearfix">
                <table class="word margin" style="border-collapse:separate; border-spacing:10px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="car_starttime" id="car_starttime" value="" class="margin02" placeholder="示例：00:00:00">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="car_endtime" id="car_endtime" value="" class="margin02" placeholder="示例：24:00:00">
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <tr>
                    <button id="load" name="load" class="margin01"  onclick="load()">提交</button>
