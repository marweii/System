                        ...
                        <li class="dropdown profile_details_drop">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <div class="profile_img">
                                    <span class="prfil-img"><img src="/resource/images/p7.png" alt=""> </span>
                                    <div class="user-name">
                                        <p>${user.name}</p>
            ...
            <div class="clearfix">
                <%--内容--%>
                    <form enctype="multipart/form-data" method="post" action="" id="choosefile" >
                        <input type="file"  name="file" id="file" class="testfile"/>
                        <input type="submit" value="上传文件" id="picup" onclick="picup()" class="button button1" />
                    </form>
            </div>
        </div>
...
<div class="sidebar-menu">
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>公交地图查询</span></a>
            </li>
