...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=WVuX709dDycjZfqt7l9YSKNPwOMATEM3"></script>
    ...
    <div class="left-content">
        <div class="mother-grid-inner">
            ...
            <div class="header-main">
                ...
                <div class="clearfix">
                    <h2 style="font-family:fantasy; font-weight:600; ">公交信息服务系统</h2>
                </div>
            </div>
            <div class="clearfix">
                <%--内容--%>
                    ...
                    <div id="driving_way">
                        ...
                        起始站点：<input type="text" id="start"/>
                        终点站点：<input type="text" id="end"/>
                        <input type="button" id="result" value="查询"/>
                    </div>
                    <script type="text/javascript">
                        // 百度地图API功能
                        var map = new BMap.Map("l-map");
                        map.centerAndZoom(new BMap.Point(120.2, 30.3), 14);
