            ...
            <div class="clearfix">
                <table class="word margin" style="border-collapse:separate; border-spacing:10px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="account" id="account" value="${user.account}" class="margin02">
                        </td>
                    </tr>
                    <tr >
                        <td>
                        ...
                        <td>
                            <input type="password" name="oldpassword" id="oldpassword" value="" class="margin02">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="password" name="newpassword1" id="newpassword1" value="" class="margin02">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="password" name="newpassword2" id="newpassword2" value="" class="margin02">
                        </td>
                    </tr>
                    </tbody>
                </table>
                <tr>
                    <button id="revise" name="revise" class="margin01"  onclick="revise()">修改</button>
    ...
    function revise() {
        if($("#newpassword1").val() != $("#newpassword2").val() ){
            ...
            $.ajax({
                ...
                url: "/login",
                async: false,
                data: {account: $("#account").val(), password: $("#oldpassword").val()},
                success: function (data) {
                    if (data["islogin"]) {
                        $.ajax({
                            ...
                            url: "/reviseuser",
                            async: false,
                            data: {account: $("#account").val(), password: $("#newpassword1").val()},
                            success: function (data) {
                                if (data["reviseuser"]) {
                                    alert("修改成功！")
                                }
