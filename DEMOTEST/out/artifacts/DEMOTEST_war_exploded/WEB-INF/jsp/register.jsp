        ...
        <div class="main-content-agile">
            ...
            <div class="sub-main-w3ls">
                <form action="/register" method="post">
                    ...
                    <input  placeholder="Enter Name" name="Name" type="text" required="" id="name">
                    <span class="icon3"><i class="fa fa-bullseye" aria-hidden="true"></i></span>
                    <div class="checkbox-w3">
                        <a href="/">Login</a>
                        <div class="clear"></div>
                    </div>
                    <input type="submit" value="" onclick="register_zc()">
                </form>
            </div>
        </div>
        <!--//main-->
...
<script type="text/javascript">
    function register_zc() {
        ...
        $.ajax({
            ...
            url:"/registerins",
            async:false,
            data:{account_register:$("#account").val(),password_register:$("#password").val(),name_register:$("#name").val()},
...
<script src="resource/js/front/login.js"></script><!--video-js-->
<!-- //js -->
</body>
</html>