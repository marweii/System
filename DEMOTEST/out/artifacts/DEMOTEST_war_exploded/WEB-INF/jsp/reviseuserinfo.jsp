                        ...
                        <li class="dropdown profile_details_drop">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <div class="profile_img">
                                    <span class="prfil-img"><img src="${touxiang}" alt=""> </span>
                                    <div class="user-name">
                                        <p>${user.name}</p>
                ...
                <%--内容--%>
                    <table class="word margin" style="border-collapse:separate; border-spacing:10px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" id="name" value="${user.name}" class="margin02">
                            </td>
                        </tr>
                        <tr >
                            <td>
                            ...
                            <td>
                                <form enctype="multipart/form-data" method="post" action="" id="choosefile" >
                                    ...
                                    <input type="submit" value="上传头像" id="picup" onclick="pictureup()" class="margin02" />
                                </form>
